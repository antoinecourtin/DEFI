...
````
* Exercice : afficher sous forme de carte les relations entre les lieux de découverte et les lieux de conservation actuels pour les objets d'intérêt archéologique 
